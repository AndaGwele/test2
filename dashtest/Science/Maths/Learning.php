...
<head>
    ...
    <title>Modern Mathematics Dashboard</title>
    <style>
    * {
        margin: 0;
        padding: 0;
    ...
    <div class="main-content" id="dashboard-content">
        ...
        <div class="dashboard-content">
            ...
            <p>
                ...
                gaining a problem-solving mindset that applies to real-world challenges. 🚀
            </p>
            ...
            <h1 class="text-center">🌍 Fields Mathematics Can Open for You:</h1>
