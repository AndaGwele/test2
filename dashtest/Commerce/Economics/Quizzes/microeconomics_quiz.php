<?php
session_start();
$questions = [['What does microeconomics study?', 'Individual economic units', ['Individual economic units', 'Overall economy', 'Government policy', 'Global trade']], ['Law of demand states?', 'Price up, demand down', ['Price up, demand down', 'Price up, demand up', 'Demand constant', 'Supply equals demand']], ['Elasticity measures?', 'Responsiveness to price changes', ['Responsiveness to price changes', 'Demand curves', 'GDP changes', 'Production levels']], ['What is marginal utility?', 'Extra satisfaction from one more unit', ['Extra satisfaction from one more unit', 'Total satisfaction', 'Fixed cost', 'Income level']], ['Perfect competition has?', 'Many sellers and identical products', ['Many sellers and identical products', 'One seller', 'Government control', 'Barriers to entry']], ['Price takers are in?', 'Perfect competition', ['Perfect competition', 'Monopoly', 'Oligopoly', 'Command economy']], ['Opportunity cost means?', 'Next best alternative foregone', ['Next best alternative foregone', 'Total cost', 'Fixed input', 'Profit margin']], ['Supply increases when?', 'Costs decrease', ['Costs decrease', 'Prices drop', 'Taxes rise', 'Demand falls']], ['What shifts the demand curve?', 'Change in income', ['Change in income', 'Change in price', 'Quantity demanded', 'Supply level']], ['Market equilibrium is?', 'Quantity demanded = Quantity supplied', ['Quantity demanded = Quantity supplied', 'Supply exceeds demand', 'Demand exceeds supply', 'Price is high']]];
...
<head>
    ...
    <title>Microeconomics Quiz</title>
    <style>
