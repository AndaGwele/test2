<?php
session_start();
$questions = [['Which is an economic goal?', 'Full employment', ['Full employment', 'Unlimited wants', 'Social unrest', 'Inflation']], ['Sustainable development means?', 'Meeting current and future needs', ['Meeting current and future needs', 'Using up all resources', 'Economic decline', 'Short-term profit']], ['Informal sector is?', 'Unregulated and unregistered work', ['Unregulated and unregistered work', 'Government employment', 'Public services', 'Banking jobs']], ['Labour-intensive method uses?', 'More workers than machines', ['More workers than machines', 'More machines', 'Capital only', 'Few people']], ['The HDI measures?', 'Quality of life indicators', ['Quality of life indicators', 'Only income', 'Military strength', 'Trade volume']], ['Privatisation is?', 'Selling state assets to private', ['Selling state assets to private', 'Nationalising companies', 'Government hiring', 'Subsidies']], ['Public goods are?', 'Non-excludable and non-rival', ['Non-excludable and non-rival', 'Paid by individuals', 'Produced for profit', 'Limited use']], ['Which is not a macro goal?', 'Individual preferences', ['Individual preferences', 'Price stability', 'Growth', 'Employment']], ['Gini coefficient shows?', 'Income inequality', ['Income inequality', 'GDP', 'Unemployment', 'Interest rates']], ['Redistribution of income is?', 'Equity measure', ['Equity measure', 'Trade action', 'Inflation target', 'Monetary policy']]];
...
<head>
    ...
    <title>Economic Pursuits Quiz</title>
    <style>
