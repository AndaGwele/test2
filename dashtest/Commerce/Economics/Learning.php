...
<head>
    ...
    <title>Modern Economics Dashboard</title>
    <style>
    * {
        margin: 0;
        padding: 0;
    ...
    .dashboard-content .text-yellow-700 {
        color: var(--primary-color);
    }
  ...
  '>
    ...
    <div class="main-content" id="dashboard-content">
        ...
        <div class="dashboard-content">
            <h1>📉 Learn Economics</h1>

            <h1 class="text-center">🔍 Introduction</h1>
            <p>
                Economics is the study of how societies allocate limited resources to meet unlimited needs. It explains
                how individuals, businesses, and governments make decisions, and how those decisions shape the world
                around
                us. 📊
            </p>

            <p>
                Whether it's understanding inflation, unemployment, market trends, or global trade, economics provides
                the tools to analyze problems, predict outcomes, and create impactful solutions. It's not just
                theory—it's
                the foundation of smart decision-making.
            </p>

            <h1 class="text-center">🌍 Fields Economics Can Open for You:</h1>

            <ul>
                <li>
                    🏦 <strong>Banking & Finance</strong> – Analyze markets and shape monetary policies!
                </li>
                <li>
                    📈 <strong>Economic Research</strong> – Study trends and guide policy decisions!
                </li>
                <li>
                    🏛️ <strong>Public Sector & Policy</strong> – Advise governments and improve welfare systems!
                </li>
                <li>
                    🌐 <strong>International Trade & Development</strong> – Work on global economic issues!
                </li>
                <li>
                    💼 <strong>Business Strategy</strong> – Help companies make data-driven decisions!
                </li>
                <li>
                    🧮 <strong>Data & Economic Analytics</strong> – Turn data into economic insights!
                </li>
            </ul>

            <p>
                Economics shapes the world—from local communities to global markets. Whether you're solving social
                problems, advising businesses, or crafting public policy, economics gives you the tools to make real
                change.
                <span class="font-semibold text-yellow-700">Think critically. Think economically. 📉</span>
            </p>
